...
qplot(stepsDaily, data=AMDpd, geom="histogram", main= "Total number of steps taken each day", xlab = "Steps per day", ylab="Frequency",col=I("blue"), fill=I("blue"))
...
qplot(stepsDaily, data=AMD3pd, geom="histogram", main="Total number of steps taken per day (missing values filled)", xlab = "Steps per day", ylab="Frequency", col=I("blue"), fill=I("blue"))
...
p <- ggplot(ex1, aes(x=interval,y=dif)) + geom_line()
p
